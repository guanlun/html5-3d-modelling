...
module.exports = class TorsionalStrut {
    ...
    simulate() {
        ...
        const torque = VecMath.scalarMult(0.001 * (theta - this.theta0), h_u);
        ...
        this.x0.acc = VecMath.add(this.x0.acc, VecMath.scalarMult(this.massMultiplier, f0));
        this.x1.acc = VecMath.add(this.x1.acc, VecMath.scalarMult(this.massMultiplier, f1));
        this.x2.acc = VecMath.add(this.x2.acc, VecMath.scalarMult(this.massMultiplier, f2));
        this.x3.acc = VecMath.add(this.x3.acc, VecMath.scalarMult(this.massMultiplier, f3));
    }
}
